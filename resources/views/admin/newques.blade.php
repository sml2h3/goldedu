        ...
        <div class="modal-dialog" role="document">
            <div class="box box-primary">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="addbutton" data-dismiss="modal"
                            onclick="addAnswer()">添加答案
                    </button>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;"
        ...
        <div class="modal-dialog" role="document">
            <div class="box box-primary">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="editInsert" data-dismiss="modal"
                            onclick="insertEdit()">修改答案
                    </button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">关闭</button>
                </div>
            </div>
